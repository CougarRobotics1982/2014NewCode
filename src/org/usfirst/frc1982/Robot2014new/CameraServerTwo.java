...
public class CameraServerTwo {
	  ...
	  private static CameraServerTwo server;

	  public static CameraServerTwo getInstance() {
	    if (server == null) {
	      server = new CameraServerTwo();
	    }
	    return server;
	  }
	  ...
	  public USBCamera m_camera1; ////storing first camera
	  public USBCamera m_camera2; ////second camera
	  private int cam = 1; ///idk anymore....
	  public USBCamera m_camera; ////current camera being used
	  ...
	  public void SetupCam(String cameraName) {
	      ...
	      if (!m_autoCaptureStarted) {
	    	  startAutomaticCapture(m_camera1);
	      }
	  }
	  
	  ////created this method to switch views from one camera to another
...
////		  USBCamera cameraCam;
//		  try {
//		      USBCamera cameraCam = new USBCamera(camera);
//		      cameraCam.openCamera();
////		      startAutomaticCapture(cameraCam);
//		      cameraCam.startCapture();
//		      m_camera = cameraCam;
//		    } catch (VisionException ex) {
//		      DriverStation.reportError(
//		          "Error when starting the camera: " + camera + " " + ex.getMessage(), true);
//		    }
	  }

	  private CameraServerTwo() {
	    m_quality = 50;
	    m_camera = null;
	    m_imageData = null;
